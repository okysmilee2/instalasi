...
data_ip="https://raw.githubusercontent.com/okysmilee2/izin/main/ip"
checking_sc() {
...
echo -e "         $COLOR1         ${WH}Telegram: t.me/D_swara    ${NC}"
echo -e "         $COLOR1      ${WH}Whatsapp: wa.me/6282380835972   ${NC}"
echo -e "         $COLOR1╰══════════════════════════════════════════╯${NC}"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/okysmilee2/izin/main/ip"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/okysmilee2/izin
    git push -f https://${TOKEN}@github.com/okysmilee2/izin.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
...
<code>```apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/okysmilee2/instalasi/main/setup.sh && chmod +x setup.sh && ./setup.sh```<code>
"
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT&parse_mode=html" $URL >/dev/null
  echo -e "\033[96m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    ...
    echo -e " ${YELL}Create Link Install${NC} : <code>```apt update && apt upgrade -y && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/okysmilee2/instalasi/main/setup.sh && chmod +x setup.sh && ./setup.sh```<code>
    echo ""
    echo -e "\033[96m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
